...
public class DesignAndOrderTacosBrowserTest {
    ...
    private void buildAndSubmitATaco(String name, String... ingredients) {
        ...
        for (String ingredient : ingredients) {
            browser.findElement(new By.ByCssSelector("input[value='" + ingredient + "']")).click();
        }
        browser.findElement(new By.ByCssSelector("input#name")).sendKeys(name);
        browser.findElement(new By.ByCssSelector("form")).submit();
    }

    private void assertDesignPageElements() {
        assertThat(browser.getCurrentUrl()).isEqualTo(designPageUrl());
        List<WebElement> ingredientGroups = browser.findElements(new By.ByClassName("ingredient-group"));
        assertThat(ingredientGroups.size()).isEqualTo(5);

        WebElement wrapGroup = browser.findElement(new By.ByCssSelector("div.ingredient-group#wraps"));
        ...
        WebElement proteinGroup = browser.findElement(new By.ByCssSelector("div.ingredient-group#proteins"));
        ...
        WebElement cheeseGroup = browser.findElement(new By.ByCssSelector("div.ingredient-group#cheeses"));
        ...
        WebElement veggieGroup = browser.findElement(new By.ByCssSelector("div.ingredient-group#veggies"));
        ...
        WebElement sauceGroup = browser.findElement(new By.ByCssSelector("div.ingredient-group#sauces"));
    ...
    private List<String> getValidationErrorTexts() {
        List<WebElement> validationErrorElements = browser.findElements(new By.ByClassName("validationError"));
    ...
    private void fillField(String fieldName, String value) {
        WebElement field = browser.findElement(new By.ByCssSelector(fieldName));
        field.clear();
    ...
    private void clickDesignATaco() {
        assertThat(browser.getCurrentUrl()).isEqualTo(homePageUrl());
        browser.findElement(new By.ByCssSelector("a[id='design']")).click();
    }

    private void clickBuildAnotherTaco() {
        assertThat(browser.getCurrentUrl()).startsWith(orderDetailsPageUrl());
        browser.findElement(new By.ByCssSelector("a[id='another']")).click();
    }
